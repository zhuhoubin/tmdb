...
public static final int OPT_CREATE_UNIONDEPUTY    = 9;
  ...
  int count_1=0;
  int count_2=0;
      jj_consume_token(UNIONDEPUTYCLASS);
      cln = classname();
                                          st.add(cln);
      jj_consume_token(AS);
      jj_consume_token(LEFT_BRACKET);
      jj_consume_token(SELECT);
      count_1 = noplusaswhereselect();
      jj_consume_token(UNION);
      jj_consume_token(SELECT);
      count_2 = noplusaswhereselect();
      jj_consume_token(RIGHT_BRACKET);
     {if (true) return count_1;}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public int noplusaswhereselect() throws ParseException {
    trace_call("noplusaswhereselect");
    try {
        String attr_s;
        String value_s = "";
        boolean plus = false;
      ...
      jj_consume_token(FROM);
      cln = classname();
                       st.add(cln);{if (true) return count;}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("noplusaswhereselect");
    }
  }
  ...
  private boolean jj_3R_14() {
    if (jj_scan_token(UNIONDEPUTYCLASS)) return true;
    if (jj_3R_20()) return true;
    return false;
  }
